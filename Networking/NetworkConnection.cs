...
public sealed class NetworkConnection : IDisposable
{
    ...
    ///     </para>
    /// </summary>
    /// <param name="tcpClient"> An already existing TcpClient. </param>
    ...
    ///     </para>
    ///     <para>
    ///         If this operation can not be completed (e.g. because this NetworkConnection is not connected), throw an InvalidOperationException.
    ///     </para>
    /// </summary>
    ...
    /// <summary>
    ///     If connected, disconnect the connection and clean up (dispose) any streams.
    /// </summary>
